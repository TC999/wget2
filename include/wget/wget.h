...
typedef struct _wget_http_connection_t wget_http_connection_t;

WGETAPI const char *wget_http_get_host(wget_http_connection_t *conn);

WGETAPI const char *wget_http_get_port(wget_http_connection_t *conn);

WGETAPI const char *wget_http_get_scheme(wget_http_connection_t *conn);

WGETAPI int wget_http_get_protocol(wget_http_connection_t *conn);
