 ...
 */
const char *wget_http_get_host(wget_http_connection_t *conn)
{
 ...
 *         _conn_ and should not be modified or freed.
 */
const char *wget_http_get_port(wget_http_connection_t *conn)
{
	return conn->port;
}
 ...
 *         _conn_ and should not be modified or freed.
 */
const char *wget_http_get_scheme(wget_http_connection_t *conn)
{
	return conn->scheme;
}
 ...
 */
int wget_http_get_protocol(wget_http_connection_t *conn)
{
